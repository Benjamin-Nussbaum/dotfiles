...
function M.config()
  ...
  local function get_buf_size()
    ...
    local bufinfo =
      vim.tbl_filter(function(buf) return buf.bufnr == cbuf end, vim.fn.getwininfo(vim.api.nvim_get_current_win()))[1]
    if bufinfo == nil then
  ...
  vim.keymap.set("n", "<leader>gg", _lazygit_toggle, { silent = true, desc = "lazygit" })
end
